    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card className="cursor-pointer hover:border-primary/50 transition-colors">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Active fellowship programs</p>
          </CardContent>
        </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Common tasks to manage your fellowship programs</CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Latest updates from your fellowship programs</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <div className="flex items-center gap-4 text-sm">
              <div className="h-2 w-2 rounded-full bg-primary" />
              <p className="text-muted-foreground">No recent activity yet. Start by creating a cohort!</p>
            </div>
          </div>
        </CardContent>
      </Card>
